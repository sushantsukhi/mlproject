...
class DataTransformation:
    def __init__(self):
        self.data_transaformation_config = DataTransformationConfig()
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            Utility.save_object(
                file_path=self.data_transaformation_config.preprocessor_obj_file_path,
            ...
            return (
                train_arr,
                test_arr,
                self.data_transaformation_config.preprocessor_obj_file_path,
            )
        except Exception as e:
            raise CustomException(e, sys)
